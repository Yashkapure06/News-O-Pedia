<template>
    <div>
        <section class="top_business">
            <h1 id="headline_text">Top USA Headlines</h1>
            <ul>
        ...
        <section class="right-side-bar">
            <h1 id="headline_text">Top Canada Headlines</h1>
            <ul>
                <li class="timebox-side" v-for="(hollywoodArticle, index) in hollywoodArticles" :key="index">
                    <router-link class="links" to="/northamerica/canada"><h5>{{ hollywoodArticle.title }}</h5></router-link>
...
export default {
    ...
    mounted(){
        ...
        newsApi.get('https://newsapi.org/v2/everything', {
            params: {
                q: 'The United Stated of America',
                from: '2023-02-18',
                to: '2023-02-18',
                sortBy: 'popularity',
                apiKey: '86f6b2f4ad2c4cb9983fe5909b911440',
