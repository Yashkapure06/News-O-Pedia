<template>
    <div>
        <section class="top_business">
            <h1 id="headline_text">Top Chinese Headlines</h1>
            <ul>
        ...
        <section class="right-side-bar">
            <h1 id="headline_text">Top Russian Headlines</h1>
            <ul>
                <li class="timebox-side" v-for="(sportsArticle, index) in sportsArticles" :key="index">
                    <router-link class="links" to="/asia/russia"><h5>{{ sportsArticle.title }}</h5></router-link>
