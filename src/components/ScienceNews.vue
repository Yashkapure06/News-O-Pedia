<template>
    <div>
        ...
        <section class="right-side-bar">
            <h1 id="headline_text">Top Bollywood Headlines</h1>
            <ul>
                <li class="timebox-side" v-for="(bollyArticle, index) in bollyArticles" :key="index">
                    <router-link class="links" to="/bollywood"> <h5>{{ bollyArticle.title }}</h5></router-link>
                    <img :src="bollyArticle.urlToImage" alt="Article image">
                </li>
            </ul>
        </section>
