<template>
    <div>
        <section class="top_business">
            <h1 id="headline_text">Top Egypt Headlines</h1>
            <ul>
        ...
        <section class="right-side-bar">
            <h1 id="headline_text">Top South Africa Headlines</h1>
            <ul>
                <li class="timebox-side" v-for="(hollywoodArticle, index) in hollywoodArticles" :key="index">
                    <router-link class="links" to="/africa/south-africa"><h5>{{ hollywoodArticle.title }}</h5></router-link>
