<template>
    <div>
        <section class="top_business">
            <h1 id="headline_text">Top Brazil Headlines</h1>
            <ul>
        ...
        <section class="right-side-bar">
            <h1 id="headline_text">Top Argentina Headlines</h1>
            <ul>
                <li class="timebox-side" v-for="(sportsArticle, index) in sportsArticles" :key="index">
                    <router-link class="links" to="/southamerica/argentina"><h5>{{ sportsArticle.title }}</h5></router-link>
