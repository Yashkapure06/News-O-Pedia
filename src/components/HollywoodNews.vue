<template>
    <div>
        ...
        <section class="right-side-bar">
            <h1 id="headline_text">Top Hollywood Headlines</h1>
            <ul>
                <li class="timebox-side" v-for="(kidsArticle, index) in kidsArticles" :key="index">
                    <router-link class="links" to="/kids"> <h5>{{ kidsArticle.title }}</h5></router-link>
                    <img :src="kidsArticle.urlToImage" alt="Article image">
                </li>
            </ul>
        </section>
